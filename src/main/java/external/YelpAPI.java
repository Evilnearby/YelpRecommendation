...
public class YelpAPI {
 ...
 private static final String CLIENT_ID = "D2G_HRASjkLxdEqkAHvwshVC0lCREAIMP9pIOb5Q_k-3BR1HoNizJSO--TV1r_apKK1R7lwZqIGbkar5ftFe0yLPQIG6v5ef62uzHdR77ZzlQ357kp4Dtge2msBfWnYx";
 //private static final String CLIENT_SECRET = "MWaXtZKF5uHnnqDgjxLNOsWGcdwp7HZU6fA3aw6W1ttY8rhjCf5GUSZk04SfrgjS";
...
// }
 ...
 public List<Item> search(double lat, double lon, String term) {
   ...
   try {
     ...
     connection.setRequestProperty("Authorization", TOKEN_TYPE + " " + CLIENT_ID);	//Bearer API_KEY
